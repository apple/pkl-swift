...
To resolve these conflicts, the https://pkl-lang.org/package-docs/<TODO_REPLACE_ME>/pkl.swift/current/swift/Name.html[`@swift.Name`]
...
[subs="+attributes"]
----
import "package://<TODO_REPLACE_ME>/pkl.swift@{pkl-swift-version}#/swift.pkl"
