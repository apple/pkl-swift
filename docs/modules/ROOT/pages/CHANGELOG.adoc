...
* Add support for resolved evaluator settings (pr:https://github.com/apple/pkl-swift/pull/172[]).
...
* Use `DecodingError.keyNotFound` error across the board when coding key is missing (pr:https://github.com/apple/pkl-swift/pull/172[]).
