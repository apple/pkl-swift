...
extension Classes {
    public enum BugKind: String, CaseIterable, CodingKeyRepresentable, Decodable, Hashable {
        case butterfly = "butterfly"
        case beetle = #"beetle""#
        case beetleOne = "beetle one"
    }

    public enum BugKindTwo: String, CaseIterable, CodingKeyRepresentable, Decodable, Hashable {
        case butterfly = "butterfly"
        case beetle = #"beetle""#
        case beetleOne = "beetle one"
    }

    public enum BugKindThree: String, CaseIterable, CodingKeyRepresentable, Decodable, Hashable {
        case butterfly = "butterfly"
        case beetle = #"beetle""#
        case beetleOne = "beetle one"
    ...
    public struct Bug: PklRegisteredType, Decodable, Hashable {
    ...
    public struct Bike: PklRegisteredType, Decodable, Hashable {
    ...
    public struct Wheel: PklRegisteredType, Decodable, Hashable {
